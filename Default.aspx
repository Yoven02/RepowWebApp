<%@ Page Title="" Language="C#" MasterPageFile="~/Client.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="WebApplication3.Default" %>
   ...
   <asp:DataList ID="dtListProducts" runat="server" CellPadding="75" ForeColor="#333333" RepeatColumns="4">
        ...
        <ItemTemplate>
            <table style="width: 220px;" cellspacing="2" cellpadding="2">
                ...
                <tr>
                    <td>
                        <img src=<%#DataBinder.Eval(Container.DataItem, "ImageURL" )%> style="width:100%; height:100px;" />
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:HyperLink ID="lnkViewMore" runat="server" NavigateUrl='<%# Eval("id") %>' Text='View More &raquo;' />
