...
<body>
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="Default.aspx">AllSport</a>
...
<hr />
  ...
  <div class="card text-black bg-success">
    <h5 class="card-title">Number of customer active</h5>
    <hr />
      <p>
              <a class="text-black">View more</a>
            </p>
  </div>
  ...
  <div class="card text-black bg-warning">
    <h5 class="card-title">Number of product</h5>
    <hr />
      <p>
              <a class="text-black">View more</a>
            </p>
  ...
  <div class="card text-black bg-danger">
    <h5 class="card-title">Number of product out of stock</h5>
    <hr />
      <p>
              <a class="text-black">View more</a>
            </p>
  ...
  <div class="card text-black bg-info">
    <h5 class="card-title">Manage review</h5>
    <hr />
      <p>
              <a class="text-black">View more</a>
            </p>
